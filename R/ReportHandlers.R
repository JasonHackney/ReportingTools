...
knitrHandlers = function(location,...)
  {
    if(missing(location))
      {
        warning("Location not specified when constructing knitr handlers. Attempting to guess based on <...>. Links/images will not work if location does not match location of file generated by knitr")
